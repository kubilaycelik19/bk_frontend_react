      ...
      <div className="bg-gradient-to-br from-orange-500 via-amber-500 to-rose-500 text-white p-10 md:p-14 rounded-3xl shadow-xl relative overflow-hidden">
        ...
        <div className="relative z-10 text-center max-w-3xl mx-auto">
          ...
          <p className="text-lg md:text-xl text-white/95 leading-relaxed mb-8 font-medium">
            ...
            sadece konuşmak istediğiniz şeyler... Hepsi için buradayım.
          </p>
...
// Hayatımdan Section Component'i
function HayatimdanSection() {
  const items = [
    {
      icon: '☕',
      title: 'Sabah Ritüelim',
      description: 'Her sabah kahvemi yudumlarken günün ilk düşüncelerini toplarım. Bu benim için bir tür meditasyon gibi. Siz de kendinize özel ritüelleriniz olduğunu keşfedebilirsiniz.',
      color: 'from-orange-50 to-amber-50',
      border: 'border-orange-100'
    },
    {
      icon: '📚',
      title: 'Öğrenmeye Açığım',
      description: 'Her danışanımdan yeni bir şey öğreniyorum. Bu mesleği sevmemin en büyük nedenlerinden biri bu: sürekli gelişiyor, büyüyorum.',
    ...
    },
    {
      icon: '🌿',
      title: 'Doğa ile Bağ',
      description: 'Zor günlerde doğaya çıkmak beni dengeler. Bazen bir yürüyüş, bazen sadece gökyüzüne bakmak... Kendinizi ne dengeliyor?',
    ...
    },
    {
      icon: '💭',
      title: 'İnsan Olmak',
      description: 'Ben de hata yapıyorum, zorlanıyorum, bazen kayboluyorum. Ama biliyorum ki bu tamamen insan olmanın bir parçası.',
    ...
    },
    {
      icon: '🎨',
      title: 'Yaratıcılık',
      description: 'Boş zamanlarımda resim yapmayı, yazı yazmayı seviyorum. Yaratıcı ifade, duyguları dışa vurmanın en güzel yollarından biri.',
      color: 'from-purple-50 to-indigo-50',
      border: 'border-purple-100'
    },
    {
      icon: '🎵',
      title: 'Müzik ile Terapi',
      description: 'Müzik ruhun gıdası derler. Doğru müzik, bazen en derin duyguları bile yüzeye çıkarabilir. Sizin de müziğiniz var mı?',
    ...
    <div className="space-y-6 md:space-y-8">
      <div className="text-center mb-8">
        ...
        <p className="text-gray-600 text-base md:text-lg max-w-2xl mx-auto">
          Günlük hayatımdan kısa kesitler, beni ben yapan şeyler...
        </p>
      </div>

      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8 relative">
        {/* Grid arka plan dekorasyonu */}
        <div className="absolute inset-0 bg-gradient-to-br from-amber-50/40 via-transparent to-orange-50/40 rounded-3xl blur-3xl -z-10 animate-pulse-slow"></div>
        
        {items.map((item, index) => (
          <ScrollAnimatedCard key={index} delay={index * 100}>
            <div
              className={`bg-gradient-to-br ${item.color} backdrop-blur-sm p-6 md:p-8 rounded-2xl border ${item.border} shadow-lg hover:shadow-2xl transition-all duration-500 hover:-translate-y-3 hover:scale-[1.02] h-full group relative overflow-hidden transform`}
            >
              {/* Floating arka plan elementi */}
              <div className={`absolute -top-4 -right-4 w-20 h-20 bg-gradient-to-br ${item.color} opacity-10 rounded-full blur-xl group-hover:opacity-20 transition-opacity duration-500 animate-float`} style={{ animationDelay: `${index * 0.2}s` }}></div>
              
              <div className="relative z-10">
                <div className="text-5xl md:text-6xl mb-4 transform group-hover:scale-110 group-hover:rotate-6 transition-all duration-500 inline-block">
                  {item.icon}
                </div>
  ...
  const items = [
    {
      ...
      description: 'Her seans sizin ihtiyaçlarınıza göre şekillenir. Ben sadece rehberlik ederim, yolculuk sizin.',
    ...
    },
    {
      ...
      description: 'Burada yargılanmazsınız, eleştirilmezsiniz. Sadece dinlenir, anlaşılır ve kabul edilirsiniz.',
    ...
    },
    {
      icon: '💬',
      title: 'Açık İletişim',
      description: 'Sorularınız, endişeleriniz, merak ettikleriniz... Hepsini konuşabiliriz. WhatsApp\'tan da bana ulaşabilirsiniz.',
    ...
    },
    {
      icon: '🌱',
      title: 'Adım Adım',
      description: 'Büyük değişiklikler bir gecede olmaz. Birlikte küçük adımlar atarız, her adım bir öncekinden güçlü olur.',
    ...
    },
    {
      ...
      description: 'Herkes farklıdır. Bu yüzden her danışanıma özel, onların ihtiyaçlarına uygun bir yol haritası çizeriz.',
    ...
    },
    {
      ...
      description: 'Kimse sizi zorlamaz. Hazır olduğunuzda, kendi ritminizde ilerlersiniz. Ben burada destek olmak için varım.',
        ...
        {items.map((item, index) => (
          <ScrollAnimatedCard key={index} delay={index * 100}>
            ...
            >
              ...
              {/* Floating arka plan elementi */}
              <div className={`absolute -top-4 -right-4 w-24 h-24 bg-gradient-to-br ${item.gradient} opacity-5 rounded-full blur-2xl group-hover:opacity-10 transition-opacity duration-500 animate-float`} style={{ animationDelay: `${index * 0.2}s` }}></div>
              
              <div className="relative z-10">
                <div className={`w-16 h-16 md:w-20 md:h-20 rounded-2xl bg-gradient-to-br ${item.gradient} flex items-center justify-center text-3xl md:text-4xl mb-4 transform group-hover:scale-110 group-hover:rotate-6 transition-all duration-500 shadow-lg`}>
                  {item.icon}
                </div>
                <h3 className="text-xl md:text-2xl font-bold text-gray-900 mb-3 group-hover:text-orange-600 transition-colors duration-300">
                  {item.title}
...
function ProfileImage() {
  ...
  const handleImageError = () => {
    // JPG yoksa PNG dene
    if (imageSrc === '/images/profile.jpg') {
      setImageSrc('/images/profile.png');
    } else {
      // Her ikisi de yoksa placeholder göster
      setImageError(true);
    }
  };
      ...
      {!imageError ? (
        ...
        <div className="absolute inset-0 bg-gradient-to-br from-amber-100/40 via-orange-100/40 to-rose-100/40 flex items-center justify-center shadow-inner backdrop-blur-sm">
          ...
          <div className="relative z-10 text-center">
            <div className="text-6xl md:text-7xl mb-4 transform group-hover:scale-110 transition-transform duration-300">👋</div>
            <p className="text-xs md:text-sm text-gray-500 font-light">
              Profil fotoğrafı ekleyin:<br />
              <span className="font-medium">public/images/profile.jpg</span>
            </p>
          </div>
          ...
          <div className="p-8 md:p-10 lg:p-12 flex flex-col justify-center bg-white/50">
            ...
            <div className="space-y-6 text-base md:text-lg text-gray-700 leading-relaxed">
              <p className="font-light">
                BAKÜ Devlet Üniversitesi'nde psikoloji eğitimi aldım. Ama aslında bu yolculuk 
                çok daha önce, insanları anlamaya çalıştığım çocukluk yıllarımda başladı.
              </p>

              {/* Quote - Modern card */}
              <div className="relative pl-6 border-l-4 border-orange-400">
                <div className="absolute -left-3 top-0 text-2xl text-orange-400">"</div>
                <p className="text-gray-800 italic font-light text-lg leading-relaxed pl-4">
                  Ben sadece Başak'ım. Sizinle birlikte yürüyen, sizi dinleyen, anlamaya çalışan biriyim.
                </p>
              </div>

              <p className="text-gray-600 font-light">
                <span className="text-orange-600 font-semibold">Herkes kendi hikayesini yazar.</span> Benim görevim, 
                bu hikayeyi birlikte okumak ve gerekirse yeniden yazmanıza yardımcı olmak.
              </p>
            </div>
          </div>
...
function HayatimdanMasonrySection() {
  const items = [
    ...
    {
      emoji: '💭',
      quote: 'Ben de zorlanıyorum, kayboluyorum. İnsan olmak bu demek. Mükemmel olmak değil.',
    ...
    {
      emoji: '📖',
        quote: 'Her danışanımdan bir şey öğreniyorum. Bu mesleği sevmemin en büyük nedenlerinden biri bu.',
    ...
    {
      emoji: '🎨',
      quote: 'Boş zamanlarımda resim yaparım. Yaratıcılık, duyguları dışa vurmanın en güzel yolu.',
    ...
    {
      emoji: '🌅',
      quote: 'Her gün yeni bir başlangıç. Her sabah yeni bir fırsat. Size de aynısını hatırlatmak istiyorum.',
        ...
        {items.map((item, index) => (
          <ScrollAnimatedCard key={index} delay={index * 100}>
            ...
            >
              ...
              {/* Floating arka plan elementi */}
              <div className={`absolute -top-4 -right-4 w-24 h-24 bg-gradient-to-br ${item.gradient} opacity-5 rounded-full blur-2xl group-hover:opacity-15 transition-opacity duration-500 animate-float`} style={{ animationDelay: `${index * 0.2}s` }}></div>
