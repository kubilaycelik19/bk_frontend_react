...
function Navbar() {
  ...
  const appointmentClass =
    'px-4 py-2 rounded-full text-sm font-semibold bg-white text-slate-700 hover:bg-slate-100 shadow-md hover:shadow-lg transition-all duration-200';
        ...
        {mobileMenuOpen && (
          <div className="md:hidden pb-4 space-y-2">
            ...
            {waUrl ? (
              ...
              <Link to="/about" onClick={() => setMobileMenuOpen(false)} className={appointmentClassMobile}>
                Randevu Al
              </Link>
            )}
          </div>
